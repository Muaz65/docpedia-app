...
public class HolderMe extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {

    private TextView time, chatText;
    private ClickListener listener;
    private ImageView image;

    public HolderMe(View v,ClickListener listener) {
        super(v);
