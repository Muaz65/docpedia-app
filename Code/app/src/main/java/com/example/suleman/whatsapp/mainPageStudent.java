...
public class mainPageStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final pagerAdapterStudent pagerAdapter=new pagerAdapterStudent(getSupportFragmentManager(),tabLayout.getTabCount());
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch (item.getItemId()){
            case R.id.refresh:
                Toast.makeText(mainPageStudent.this, "Refreshed" , Toast.LENGTH_SHORT).show();
                return true;
            case R.id.logout:
                Toast.makeText(mainPageStudent.this, "Logout" ,Toast.LENGTH_SHORT).show();
                finishAffinity();
                return true;
            default:
                return super.onOptionsItemSelected(item);
