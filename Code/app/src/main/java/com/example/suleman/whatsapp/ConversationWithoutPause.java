...
public class ConversationWithoutPause extends BaseActivity implements HolderMe.ClickListener, HolderYou.ClickListener {
          ...
          //          public void run() {
                  ...
                  //      count++;
                    //    if(count >= 300) {
                      ...
                      //      end = true;
                     //       submitUi.setVisibility(View.VISIBLE);
   //                     }
                        //}
    ...
    public void selectImage()
    {
        ...
        AlertDialog.Builder alert=new AlertDialog.Builder(ConversationWithoutPause.this);
